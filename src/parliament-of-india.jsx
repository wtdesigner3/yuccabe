            ...
            <div className="project-details-1-area project-details-1-pt">
                <div className="container-fluid p-0">
                    <div className="row g-0">
                        <div className="col-xl-7 image-moblie-silde">
                            ...
                            <div className="project-details-1-right-wrap" >
                                <div className="project-details-1-right position-relative">
                                    <div className="project-details-1-title-box">
                                        ...
                                        <h4 className="project-details-1-title">Parliament of India</h4>
                                    ...
                                    <div className="project-details-1-social">
                                        ...
                                        <div className="project-details-1-social-main">
                                            <a className="share-icon" href="#"  onClick={(e) => {
                                                e.preventDefault();
                                                navigator.clipboard.writeText(window.location.href);
                                                const copyShare = document.querySelector('.copy-share-text');
                                                copyShare.style.display = "block";
                                                setTimeout(() =>{
                                                    copyShare.style.display = "none";
                                                },2000)
                                            }}>
                                                <span>
                                                    <svg
