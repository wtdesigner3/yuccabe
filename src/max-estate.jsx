                                ...
                                <div className="project-details-1-right position-relative">
                                    ...
                                    <div className="project-details-1-info-wrap">
                                        <div className="project-details-1-info">
                                            <span>Client:</span>
                                            <h4>Max Estates 360</h4>
                                        </div>
                                        <div className="project-details-1-info">
                                            <span>Location:</span>
                                            <h4>Okhla, Delhi(22-23’); Noida sec -16A(2016), Max 360 Experience centre (25’), Max Estates 128 (2024); MAX square sec135 Noida(23-24’).</h4>
                                        </div>
                                        <div className="project-details-1-info">
                                    ...
                                    <div className="project-details-1-title-box pt-4">
                                        <div className="project-details-1-info">
                                            <h4 className="project-details-1-title pb-4" style={{fontSize:30}}>What was the objective?</h4>
                                          
                                            <p>Max Estates, known for their premium commercial and residential developments, approached Yuccabe Planters with a need for bespoke planter solutions. Their vision: to integrate planters seamlessly into the architectural language of their interiors and landscapes. This included:</p>
                                            <ul className=''>
                                                <li>
                                                    <p>
                                                        Ensuring aesthetic harmony with the interior finishes and landscape materials.
                                                    </p>
                                                </li>
                                                <li>
                                                    <p>
                                                        Creating durable outdoor planters capable of withstanding harsh climate conditions.
                                                    </p>
                                                </li>
                                                <li>
                                                    <p>
                                                       Designing planters in specific sizes, shapes, and colors to fit designated spaces and complement furniture and finishes.
                                                    </p>
                                                </li>
                                                <li>
                                                    <p>
                                                        Blending modern minimalism with elements of natural elegance.
                                                    </p>
                                                </li>
                                            </ul>
                                            <h4 className="project-details-1-title pb-4" style={{fontSize:30}}>The Yuccabe Planter Approach</h4>
                                            <p>Yuccabe’s design and production team collaborated closely with Max Estates' architects and landscape consultants throughout the developmental phases.</p>
                                            <p>We proposed what would fit best according to the architecture:</p>
                                            <p>- Sleek matte-finish planters in muted tones for corridors and common lounges.</p>
                                            <p>- Textured stone-look planters for patios and balconies.</p>
                                            <p>- Oversized contemporary pots for grand landscape entrances and central courtyards.</p>
                                            <p>Over 1200+ custom planters delivered within designated production timeline across all the projects.</p>
                                            <p>Coordinated logistics for phased delivery across different Max sites.</p>
                                            <p>The Impact</p>
                                            <ul>
                                                <li>The planters became integral design elements in Max Estates' interiors and landscape design.</li>
                                                <li>Enhanced the biophilic appeal of both workspaces and living spaces.</li>
                                                <li>Proved that durable, lightweight, and aesthetic planters can be made entirely in India, on a custom basis, without compromising on quality.</li>
                                            </ul>
                                            <p>We remain committed to enhancing spaces through intelligent greening — blending design and durability.</p>
                                        </div>
                                    </div> 
