...
export default function jamnagar() {
    useEffect(() => {
                        ...
                        <div className="col-xl-5">
                            <div className="project-details-1-right-wrap" >
                                ...
                                <div className="project-details-1-navigation d-flex justify-content-between align-items-center">
                                    <a className="project-details-1-prev" href="/parliament-of-india" >
                                    ...
                                    <a className="project-details-1-next" href="/indira-gandhi-international-airport-t1" >
                                        <span>Next</span>
