...
markers:true,
            ...
            gsap.set(".panel", {
                height: (sections.length * 611),
            });
            tlMain.fromTo(".small-section", { y: "100vh" }, { y: 40, duration: 0.5 });
            tlMain.fromTo('.panel', { y: "102%" }, { y: '4.4%', duration: 1 });
                ...
                <div className="stack-container">
                    ...
                    {/* <div className="panels"> */}
                        {sections.map(({ Entry_ID, Product_Name, Product_Subtitle, Product_Description, Sizes_Image_Link, Category_ID, Images }) => (
                            <div className={" p-0 panel" + Entry_ID} key={Entry_ID} data-category={Category_ID}>
